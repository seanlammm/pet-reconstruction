...
def print_input_file(index, dir_path, source_dir, scanner_geo, phantom_dim, phantom_voxel_size, phantom_material_file, phantom_density_file):
    ...
    energy_blur_params = (1, 511000, 0.12, 0, 0)
...
if __name__ == "__main__":
    ...
    img = np.fromfile("/share/home/lyj/files/gate_script/HPBrain_72mm_radius_cylinder/root_output/recon_trues_scatters_wtof_1000ps/recon_trues_scatters_wtof_1000ps_it6.img", dtype=np.float32).reshape(phantom_dim).astype(np.float32)
    mumap = np.fromfile("/share/home/lyj/files/gate_script/HPBrain_72mm_radius_cylinder/HPBrain_72mm_radius_cylinder/mumap-MuMap.raw", dtype=np.float32).reshape(phantom_dim).astype(np.float32)
    phantom_material_file = "/share/home/lyj/Downloads/gPET_to_SZBL/Example/input/phantom_72mm_radius_cylinder/cylinder_index.raw" # int32 material index image(in castor dimension)(index in matter4gpet)
    phantom_density_file = "/share/home/lyj/Downloads/gPET_to_SZBL/Example/input/phantom_72mm_radius_cylinder/cylinder_density.raw"  # float32 density image(in castor dimension)
    sim_name = "sim_72mm_cylinder_10m"
