...
if __name__ == "__main__":
    phantom_dim = np.array([71, 384, 384])  # [z, y, x]
    phantom_voxel_size = np.array([0.279, 0.13, 0.13])  # [z, y, x]
    img = np.fromfile("/share/home/lyj/files/11panel_recon/20251027_human/recon_20251027_human_10m_events_scit2_scale_by_sinogram_all_bin_sum_in_tof/recon_20251027_human_10m_events_scit2_scale_by_sinogram_all_bin_sum_in_tof_it6.img", dtype=np.float32).reshape(phantom_dim).astype(np.float32)
    mumap = np.fromfile("/share/home/lyj/files/11panel_recon/20251027_human/lac_ge_size_registrated.img", dtype=np.float32).reshape(phantom_dim).astype(np.float32)
    phantom_material_file = "/share/home/lyj/Downloads/gPET_to_SZBL/Example/input/phantom_20251027_human/20251027_human_index.raw" # int32 material index image(in castor dimension)(index in matter4gpet)
    phantom_density_file = "/share/home/lyj/Downloads/gPET_to_SZBL/Example/input/phantom_20251027_human/20251027_human_density.raw" # float32 density image(in castor dimension)
    sim_name = "20251027_human_10m_events_scit3"
