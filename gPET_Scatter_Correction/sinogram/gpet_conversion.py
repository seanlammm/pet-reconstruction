...
from gPET_Scatter_Correction.sinogram.others import tof_blurring, castor_id_to_block_base_sinogram, get_cdf_info, get_block_base_sinogram_index
from gPET_Scatter_Correction.sinogram.scaling_method import get_scale_by_sinogram_edge_fit, get_scale_by_total_events, get_scale_by_events_num_of_each_tof_bin, get_scale_by_sinogram_bin_counts_sum_all_tof
...
def add_scf_to_tof_cdf(input_cdf_path, gpet_prompt_cdf_path, gpet_scatter_cdf_path, acf_path, nf_path, scan_time, output_dir, output_filename, mumap):
    ...
    # castor_ids in crystal-base and sino_index in block-base
    target_cdf = get_cdf_info(cdf_path=input_cdf_path, tof_option=tof_option, wrr=1, wtof=1)
    ...
    scatter_sinogram = castor_id_to_block_base_sinogram(cdf_data=gpet_scatter_cdf, scanner_option=module_base_scanner_option, tof_option=tof_option)
    # scatter_sinogram = get_scale_by_total_events(target_cdf_in_bb, gpet_prompt_cdf_bb, scan_time, scatter_sinogram, module_base_scanner_option)
    # scatter_sinogram = get_scale_by_events_num_of_each_tof_bin(target_cdf=target_cdf, gpet_cdf=gpet_prompt_cdf, scan_time=scan_time, tof_option=tof_option, scatter_sinogram=scatter_sinogram, scanner_option=module_base_scanner_option)
    # scatter_sinogram = get_scale_by_sinogram_edge_fit(target_cdf=target_cdf_in_bb, target_sino_index=target_sino_index_in_bb, gpet_sino_index=gpet_prompt_sino_index_bb, scan_time=scan_time, tof_option=tof_option, scatter_sinogram=scatter_sinogram, scanner_option=module_base_scanner_option, mumap=mumap, device_id="0")
    scatter_sinogram = get_scale_by_sinogram_bin_counts_sum_all_tof(target_cdf=target_cdf, gpet_prompt_cdf=gpet_prompt_cdf, scan_time=scan_time, scatter_sinogram=scatter_sinogram, scanner_option=module_base_scanner_option, tof_option=tof_option)
    scatter_sinogram /= (6400 * 2)

    sino_index, rm_option = get_block_base_sinogram_index(cdf_data=target_cdf, scanner_option=module_base_scanner_option, tof_option=tof_option)
    if np.any(rm_option):
        target_cdf = target_cdf[~rm_option, :]
    scf = scatter_sinogram[sino_index]
...
if __name__ == "__main__":
    ...
    add_scf_to_tof_cdf(
        ...
        "trues_scatters_wtof_wacf_wnorm_wgpettofscf_1000ps_scale_by_sinogram_all_tof_bin_fit",
    ...
    #     128,
    #     "/share/home/lyj/files/gate_script/HPBrain_72mm_radius_cylinder/root_output/",
    #     "trues_scatters_wtof_wacf_wnorm_wgatetofscf_1000ps_save_id_reverse_and_div_2",
    #     np.fromfile("/share/home/lyj/files/gate_script/HPBrain_72mm_radius_cylinder/HPBrain_72mm_radius_cylinder/mumap-MuMap.raw", dtype=np.float32).reshape([300, 300, 300]).transpose([2, 1, 0])/10
    # )
    # modified_lm_cdf()
    ...
    # #################################################
    # get_cdf(
    #     "/share/home/lyj/Downloads/gPET_to_SZBL/Example/output/20251027_human_crystal_base/output_20251027_human_10m_events_scit2/",
    #     "/share/home/lyj/Downloads/gPET_to_SZBL/Example/output/20251027_human_crystal_base/cdf_20251027_human_10m_events_scit2/",
    #     "20251027_human_true_scatter_10m_events_scit2",
    #     True,
    #     True,
    #     1000
    # )
    ...
    #     "/share/home/lyj/Downloads/gPET_to_SZBL/Example/output/20251027_human_crystal_base/output_20251027_human_10m_events_scit2/",
    #     "/share/home/lyj/Downloads/gPET_to_SZBL/Example/output/20251027_human_crystal_base/cdf_20251027_human_10m_events_scit2/",
    #     "20251027_human_scatter_10m_events_scit2",
    #     True
    # )
    # add_scf_to_tof_cdf(
    ...
    #     "20251027_human_10m_events_scit1_scale_by_sinogram_all_bin_sum_in_tof",
    #     ""
    # )
#######################################
    # get_cdf(
    #     "/share/home/lyj/Downloads/gPET_to_SZBL/Example/output/20251223_hoffman_crystal_base/output_20251223_hoffman_5m_events_scit2/",
    #     "/share/home/lyj/Downloads/gPET_to_SZBL/Example/output/20251223_hoffman_crystal_base/cdf_20251223_hoffman_5m_events_scit2/",
    #     "20251223_hoffman_5m_true_scatter_scit2",
    #     True,
    #     True,
    #     1000
    # )
    ...
    #     "/share/home/lyj/Downloads/gPET_to_SZBL/Example/output/20251223_hoffman_crystal_base/output_20251223_hoffman_5m_events_scit2/",
    #     "/share/home/lyj/Downloads/gPET_to_SZBL/Example/output/20251223_hoffman_crystal_base/cdf_20251223_hoffman_5m_events_scit2/",
    #     "20251223_hoffman_5m_scatter_scit2",
    #     True
    # )
    # add_scf_to_tof_cdf(
    #     "/share/home/lyj/files/11panel_recon/20251223_hoffman/20251223_sum_up_wrr_wtof_wengwin_410_610_tw1000ps.cdf",
    #     "/share/home/lyj/Downloads/gPET_to_SZBL/Example/output/20251223_hoffman_crystal_base/cdf_20251223_hoffman_10m_events_scit1/20251223_hoffman_10m_true_scatter_scit1.cdf",
    #     "/share/home/lyj/Downloads/gPET_to_SZBL/Example/output/20251223_hoffman_crystal_base/cdf_20251223_hoffman_10m_events_scit1/20251223_hoffman_10m_scatter_scit1.cdf",
    #     "/share/home/lyj/files/11panel_recon/20251223_hoffman/acfactor_20251223_hoffman_lac_registrated.img",
    #     "/share/home/lyj/files/11panel_recon/20251028_cylinder_norm/20251028_norm_factor.raw",
    #     1500,
    #     "/share/home/lyj/files/11panel_recon/20251223_hoffman/",
    #     "20251223_hoffman_sum_up_5m_events_scit1_scale_by_sinogram_all_bin_sum_in_tof",
    #     ""
    # )
